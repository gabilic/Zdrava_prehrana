...
<html>
    ...
    <body class="background_2" onload="narudzbeProizvodjac();">
        <div id="container">
            <div class="w3-top">
            ...
            <div class="w3-content" style="max-width:1200px">
                <div class="w3-main">
                    ...
                    <header class="w3-container w3-xxxlarge">
                        <p class="w3-center w3-text-white">Narudžbe</p>
                    </header>

                    <div class="w3-container w3-light-grey w3-padding-32 m_padding_small">
                        <div>
                            <div>
                                <p>U sljedećem obrascu se nalazi popis narudžbi kupaca sortiranih po datumu i vremenu primitka,
        ...
        <script type="text/javascript" src="js/narudzbe_proizvodjac.js?<?php echo filemtime("js/narudzbe_proizvodjac.js") ?>"></script>
