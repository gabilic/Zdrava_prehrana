...
$poruka = "Uspješno ste aktivirali svoj korisnički račun. Sada se možete prijaviti u sustav Zdrava prehrana.";

if(!provjeriKod()) {
    $poruka = "Pojavila se pogreška prilikom aktivacije. Aktivacijski kod nije pronađen u bazi podataka. Korisnički račun nije aktiviran!";
}
else if(!provjeriVrijeme()) {
    $poruka = "Pojavila se pogreška prilikom aktivacije. Aktivacijski kod je istekao. Korisnički račun nije aktiviran!";
}
else {
    aktivirajKorisnika();
}
            ...
            <div class="w3-content" style="max-width:1200px">
                <div class="w3-main">
                    ...
                    <header class="w3-container w3-xxxlarge">
                        <p class="w3-center w3-text-white">Aktivacija</p>
                    </header>
