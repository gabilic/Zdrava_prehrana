...
if(!(isset($_SESSION["prijava"]) && $_SESSION["prijava"][3] === "administrator")) {
...
<html>
    ...
    <body class="background_2" onload="administracija();">
        <div id="container">
            <div class="w3-top">
            ...
            <div class="w3-content" style="max-width:1200px">
                <div class="w3-main">
                    ...
                    <header class="w3-container w3-xxxlarge">
                        <p class="w3-center w3-text-white">Administracija</p>
                    </header>

                    <div class="w3-container w3-light-grey w3-padding-32 m_padding_small">
                        <div>
                            <div>
                                <p>U sljedećem obrascu se nalazi popis korisnika koji su se registrirali kao proizvođači, kao i osnovni podaci
                                    vezani uz njihove korisničke račune. Kako bi se izbjegla zloupotreba podataka, korisnici će moći
                                    aktivirati svoje korisničke račune tek nakon što im to Vi odobrite:</p>
                            </div>
                            <div style="text-align: center; margin: 20px auto 20px auto">
                                <div class="administracija_input m_input">
                                    <p style="margin-top: 0px">
                                        <select id="korisnicko_ime" name="korisnicko_ime" class="w3-select w3-border">
                                            <option value="0" disabled selected>Korisničko ime</option>
                                        </select>
                                    </p>
                                </div>
                                <div class="m_input" style="display: inline-block; vertical-align: top">
                                    <p style="margin-top: 0px">
                                        <button id="prikazi" name="prikazi" type="button" class="w3-btn w3-padding w3-red w3-margin-top w3-margin-bottom w3-margin-right button" style="margin: 0!important" onclick="prikaziKorisnika(); return false;">Prikaži</button>
                                    </p>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="js/administracija.js?<?php echo filemtime("js/administracija.js") ?>"></script>
