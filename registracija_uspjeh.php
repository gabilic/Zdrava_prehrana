            ...
            <div class="w3-content" style="max-width:1200px">
                <div class="w3-main">
                    ...
                    <header class="w3-container w3-xxxlarge">
                        <p class="w3-center w3-text-white">Uspješna registracija</p>
                    </header>
                    ...
                    <div class="w3-container w3-light-grey w3-padding-32 m_padding_small">
                        <div>
                            <?php
                            $tip_registracije = "1";
                            if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["tip"]) && ($_GET["tip"] === "1" || $_GET["tip"] === "2")) {
                                $tip_registracije = $_GET["tip"];
                            }
                            if($tip_registracije === "1") {
                                echo "<p>Uspješno ste se registrirali kao kupac! Na Vašu e-mail adresu će uskoro stići poruka koja sadrži link za " .
                                        "aktivaciju korisničkog računa. Nakon što aktivirate korisnički račun, moći ćete se prijaviti u sustav " .
                                        "Zdrava prehrana.</p>";
                            }
                            else if($tip_registracije === "2") {
                                echo "<p>Uspješno ste se registrirali kao proizvođač! Nakon što administrator potvrdi valjanost Vaših korisničkih " .
                                        "podataka, na e-mail adresu će Vam stići poruka koja sadrži link za aktivaciju korisničkog računa. Aktivacijom " .
                                        "korisničkog računa moći ćete se prijaviti u sustav Zdrava prehrana.</p>";
                            }
                            ?>
                        </div>
                    </div>
